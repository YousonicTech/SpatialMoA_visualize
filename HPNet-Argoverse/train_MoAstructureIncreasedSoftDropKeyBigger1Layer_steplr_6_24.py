...
from model import HPNet_MoAStructureIncreasedSoftDropKeyBigger1Layer_StepLR_6_24 as HPNet
...
if __name__ == '__main__':
    ...
    trainer = pl.Trainer(devices=args.devices, accelerator='gpu', callbacks=[model_checkpoint, lr_monitor],
