...
from layers import StructureIncreasedKeyDropGraphAttention_BigR
...
class Backbone_StructureIncreasedDropKey_BigR_Bigger1layer_6_24(nn.Module):
    ...
    def __init__(self,
                 ...
                 num_heads: int,
                 dropout: float) -> None:
        super(Backbone_StructureIncreasedDropKey_BigR_Bigger1layer_6_24, self).__init__()
        ...
        self.l2m_attn_layer = StructureIncreasedKeyDropGraphAttention_BigR(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
                                                      has_edge_attr=True, if_self_attention=False, mask_ratio=0.05,num_r_bins = 8,num_theta_bins = 24)
        self.t2m_attn_layer = StructureIncreasedKeyDropGraphAttention_BigR(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
                                                      has_edge_attr=True, if_self_attention=False, mask_ratio=0.1,num_r_bins = 8,num_theta_bins = 24)
        ...
        self.l2n_attn_layer = GraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
                                                      has_edge_attr=True, if_self_attention=False)#GraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
