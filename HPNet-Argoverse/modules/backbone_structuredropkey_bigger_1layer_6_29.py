...
class Backbone_StructureDropKey_Bigger1layer_6_29(nn.Module):
    ...
    def __init__(self,
                 ...
                 num_heads: int,
                 dropout: float) -> None:
        super(Backbone_StructureDropKey_Bigger1layer_6_29, self).__init__()
        ...
        self.l2m_attn_layer = StructureKeyDropGraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
                                                      has_edge_attr=True, if_self_attention=False, mask_ratio=0.05,num_r_bins = 6,num_theta_bins = 29)
        self.t2m_attn_layer = StructureKeyDropGraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
                                                      has_edge_attr=True, if_self_attention=False, mask_ratio=0.1,num_r_bins = 6,num_theta_bins = 29)
