...
class Backbone_DropKey_Bigger2layer(nn.Module):
    ...
    def __init__(self,
                 ...
                 num_heads: int,
                 dropout: float) -> None:
        super(Backbone_DropKey_Bigger2layer, self).__init__()
        ...
        self.l2n_attn_layer = KeyDropGraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
                                                      has_edge_attr=True, if_self_attention=False, mask_ratio=0.1)#GraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
        ...
        self.t2n_attn_layer = KeyDropGraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
                                                      has_edge_attr=True, if_self_attention=False, mask_ratio=0.2)#GraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
                              #               has_edge_attr=True, if_self_attention=False)
