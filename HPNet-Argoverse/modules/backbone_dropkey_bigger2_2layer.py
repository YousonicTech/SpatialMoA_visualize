...
class Backbone_DropKey_Bigger22layer(nn.Module):
    ...
    def __init__(self,
                 ...
                 num_heads: int,
                 dropout: float) -> None:
        super(Backbone_DropKey_Bigger22layer, self).__init__()
        ...
        self.l2m_attn_layer = KeyDropGraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
                                                      has_edge_attr=True, if_self_attention=False, mask_ratio=0.05)
        self.t2m_attn_layer = KeyDropGraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
                                                      has_edge_attr=True, if_self_attention=False, mask_ratio=0.1)
        ...
        self.l2n_attn_layer = KeyDropGraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
                                                      has_edge_attr=True, if_self_attention=False, mask_ratio=0.025)#GraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
                              #               has_edge_attr=True, if_self_attention=False)
        self.t2n_attn_layer = KeyDropGraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
                                                      has_edge_attr=True, if_self_attention=False, mask_ratio=0.05)#GraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
                              #               has_edge_attr=True, if_self_attention=False)
...
if __name__ == "__main__":
    ...
    num_heads = 8
    dropout = 0.1
    BackboneOnlyRegister_instance = Backbone_PathMask(
