...
from layers import MoAStructureIncreasedSoftKeyDropGraphAttention
...
class Backbone_MoAStructureIncreasedSoftDropKey_Bigger1layer_6_24(nn.Module):
    ...
    def __init__(self,
                 ...
                 num_heads: int,
                 dropout: float) -> None:
        super(Backbone_MoAStructureIncreasedSoftDropKey_Bigger1layer_6_24, self).__init__()
        ...
        self.l2m_attn_layer = MoAStructureIncreasedSoftKeyDropGraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
                                                      has_edge_attr=True, if_self_attention=False, mask_ratio=0.05,num_r_bins = 6,num_theta_bins = 24)
        self.t2m_attn_layer = MoAStructureIncreasedSoftKeyDropGraphAttention(hidden_dim=hidden_dim, num_heads=num_heads, dropout=dropout,
...
if __name__ == "__main__":
    ...
    num_heads = 8
    dropout = 0.1
    BackboneOnlyRegister_instance = Backbone_MoAStructureIncreasedDropKey_Bigger1layer_6_24(
