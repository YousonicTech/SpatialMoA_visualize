...
class MoAStructureIncreasedKeyDropGraphAttention(MessagePassing):
    ...
    def __init__(self,
                ...
                num_theta_bins: int,
                 **kwargs) -> None:
        super(MoAStructureIncreasedKeyDropGraphAttention, self).__init__(aggr='add', node_dim=0, **kwargs)
