...
from modules import Backbone_MoAStructureIncreasedDropKey_Bigger1layer_6_24 as Backbone
...
class HPNet_MoAStructureIncreasedDropKeyBigger1Layer_StepLR_6_24(pl.LightningModule):
    ...
    def __init__(self,
                 ...
                 T_max: int,
                 **kwargs) -> None:
        super(HPNet_MoAStructureIncreasedDropKeyBigger1Layer_StepLR_6_24, self).__init__()
    ...
    def add_model_specific_args(parent_parser):
        parser = parent_parser.add_argument_group('HPNet_MoAStructureIncreasedDropKeyBigger1Layer_StepLR_6_24')
