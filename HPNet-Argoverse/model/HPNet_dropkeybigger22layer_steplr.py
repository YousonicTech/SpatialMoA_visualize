...
from modules import Backbone_DropKey_Bigger22layer as Backbone
...
class HPNet_DropKeyBigger22Layer_StepLR(pl.LightningModule):
    ...
    def __init__(self,
                 ...
                 T_max: int,
                 **kwargs) -> None:
        super(HPNet_DropKeyBigger22Layer_StepLR, self).__init__()
    ...
    def add_model_specific_args(parent_parser):
        parser = parent_parser.add_argument_group('HPNet_DropKeyBigger22Layer_StepLR')
