...
from modules import Backbone_StructureDropKey_Bigger1layer_6_29 as Backbone
...
class HPNet_StructureDropKeyBigger1Layer_StepLR_6_29(pl.LightningModule):
    ...
    def __init__(self,
                 ...
                 T_max: int,
                 **kwargs) -> None:
        super(HPNet_StructureDropKeyBigger1Layer_StepLR_6_29, self).__init__()
