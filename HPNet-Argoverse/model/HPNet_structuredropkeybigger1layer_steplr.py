...
from modules import Backbone_StructureDropKey_Bigger1layer as Backbone
...
class HPNet_StructureDropKeyBigger1Layer_StepLR(pl.LightningModule):
    ...
    def __init__(self,
                 ...
                 T_max: int,
                 **kwargs) -> None:
        super(HPNet_StructureDropKeyBigger1Layer_StepLR, self).__init__()
