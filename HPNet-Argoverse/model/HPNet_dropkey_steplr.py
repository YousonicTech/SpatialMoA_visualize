...
from modules import Backbone_DropKey as Backbone
...
class HPNet_DropKey_StepLR(pl.LightningModule):
    ...
    def __init__(self,
                 ...
                 T_max: int,
                 **kwargs) -> None:
        super(HPNet_DropKey_StepLR, self).__init__()
    ...
    def add_model_specific_args(parent_parser):
        parser = parent_parser.add_argument_group('HPNet_DropKey_StepLR')
