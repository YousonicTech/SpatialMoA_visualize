...
from modules import Backbone_StructureIncreasedDropKey_BigR_Bigger1layer_6_24 as Backbone
...
class HPNet_StructureIncreasedDropKeyBigger1Layer_BigR_StepLR_6_24(pl.LightningModule):
    ...
    def __init__(self,
                 ...
                 T_max: int,
                 **kwargs) -> None:
        super(HPNet_StructureIncreasedDropKeyBigger1Layer_BigR_StepLR_6_24, self).__init__()
    ...
    def add_model_specific_args(parent_parser):
        parser = parent_parser.add_argument_group('HPNet_StructureIncreasedDropKeyBigger1Layer_BigR_StepLR_6_24')
